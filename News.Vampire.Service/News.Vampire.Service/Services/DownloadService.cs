...
namespace News.Vampire.Service.Services
{
    public class DownloadService : BackgroundService
    {
        ...
        {
            _logger.LogDebug($"DownloadService is starting.");

            stoppingToken.Register(() =>
                _logger.LogDebug($" DownloadService background task is stopping."));
            ...
            using (var scope = _serviceScopeFactory.CreateScope())
            {
                ...
                {
                    _logger.LogDebug($"DownloadService task doing background work.");
